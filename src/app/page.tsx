    ...
    <main className="min-h-screen px-4 py-12 sm:py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-10 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-brand-100 px-4 py-1.5 text-sm font-medium text-brand-700 dark:bg-brand-900/40 dark:text-brand-300">
